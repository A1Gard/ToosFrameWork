...
$frm->AddField('text', _lg('title'), null, array('name' => 'category_title', 'class' => 'full-width'));
$frm->AddField('select', _lg('Parent'), null, array('name' => 'category_parent'), $this->cat->CategoryByExpect());
$frm->AddField('textarea', _lg('Description'), null, array('name' => 'category_description', "rows" => '10', 'class' => 'ckeditor'));
                    ...
                    <li> 
                        <div  class="row">
                            ...
                            <div class="grd6">
                                ...
                                <a class="ui button blue" href="<?php echo UR_MP ?>Category/Edit/<?php echo $cls['category_id'] ?>"> <?php echo _lp('Edit'); ?> </a>
                            </div>
                        </div>
                    </li>
                <?php endforeach; ?>
