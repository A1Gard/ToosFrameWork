...
$listview->AddColum(('Status'), '%1comment_status', 2);
$listview->AddColum(('ip'), '%icomment_ip', 3);
$listview->AddColum(("Datetime"), '%ucomment_time', 3);
$listview->AddColum(('Commenter'), 'manager_displayname,member_name', 3);
$listview->AddColum(('title'), 'topic_title', 7);
