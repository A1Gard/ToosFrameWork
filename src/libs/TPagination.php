...
class TPagination {
    ...
    public function Render($acvtive_page = '') {
        ...
        // make prefix link
        $prefix = GetLinkPrefix('page');

        $result =  '<div class="pagination">';

        // if greater than 1 show first and prv
        if ($acvtive_page > 1) {
            $result .= '<a href="' . $prefix . "page=" . (1) . '" title="' . _lg('First') . '" >' . '&lt;&lt;' . "</a> \n";
            $result .= '<a href="' . $prefix . "page=" . ($acvtive_page - 1) . '" >' . _lg('Previous') . "</a> \n";
        }
        ...
        if ($acvtive_page < $this->page_count) {
            $result .= '<a href="' . $prefix . "page=" . ($acvtive_page + 1) . '" >' . _lg('Next') . "</a> \n";
            $result .= '<a href="' . $prefix . "page=" . ($this->page_count) . '" title="' . _lg('Last') . '" >' . '&gt;&gt;' . "</a> \n";
        }
        $result .= '</div>';
