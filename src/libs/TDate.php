 ...
 * @author other: parsidate By Mobin Ghasempoor- hijri date by Abdulrhman Alkhodiry 
 */
class TDate {
...
################################################################################    
    ...
    private $persian_short_month_names = array('', 'فرو', 'ارد', 'خرد', 'تیر', 'مرد', 'شهر', 'مهر', 'آ​با', 'آذر', 'دی', 'بهم', 'اسف');
    ...
    var $a = Array("ar" => Array("am" => "ص", "pm" => "م"));
    var $A = Array("ar" => Array("AM" => "صباحاً", "PM" => "مساءً"));
...
################################################################################    
    ...
    public function PDate($format, $time = "now") {
        ...
        // Pre hook
        _hk('P' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $format, $time);
...
//    }
     ...
     *
     */
    function IDate($format, $time_stamp = 'now') {
        ...
        $date = str_replace(array("¢", "£", "ç", "¥", "©", "ï", "â", "®"), array($D, $l, $S, $F, $M, $a, $A, $r), $date);
         ...
         // result hook
        _hk('R' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $date);
...
################################################################################    
    ...
    private function _makeTime($time) {
         ...
         // pre hook
        _hk('P' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $time);
        
        $time_stamp = is_numeric($time) && (int) $time == $time ? $time : strtotime($time);

         // result hook
        _hk('R' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $time_stamp);
    ...
    private function _getIslamicMonthName($month, $shorten = false) {
        $longMonth = array("en" => Array(1 => "Muharram", "Safar", "Rabi' I", "Rabi' II", "Jumada I", "Jumada II", "Rajab", "Sha'aban", "Ramadan", "Shawwal", "Dhu al-Qi'dah", "Dhu al-Hijjah"), "ar" => Array(1 => "محرّم", "صفر", "ربيع الأول", "ربيع الآخر", "جمادى الأول", "جمادى الآخر", "رجب", "شعبان", "رمضان", "شوّال", "ذو القعدة", "ذو الحجة"));
        $shortMonth = Array("en" => Array(1 => "Muh", "Saf", "Rb1", "Rb2", "Jm1", "Jm2", "Raj", "Shb", "Rmd", "Shw", "DhQ", "DhH"), "ar" => Array(1 => "مح", "صف", "ر1", "ر2", "ج1", "ج2", "رج", "شع", "رم", "شو", "ذق", "ذح"));
    ...
    private function _getIslamicDayName($day, $shorten = false) {
        $daySingle = Array(
            "en" => Array(1 => "Mon", "Tue", "Wed", "Thur", "Fri", "Sat", "Sun"),
            "ar" => Array(1 => "اثنين", "ثلاثاء", "أربعاء", "خميس", "جمعة", "سبت", "احد")
        );
        $dayPlural = Array(
            "en" => Array(1 => "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"),
            "ar" => Array(1 => "الاثنين", "الثلاثاء", "الأربعاء", "الخميس", "الجمعة", "السبت", "الأحد",)
        );
...
################################################################################    
    ...
    public function Str2Ism($strDate, $format = "d-m-Y") {
        // Pre hook
        _hk('P' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $strDate, $format);
    ...
    public function Ge2Ism($day = 20, $month = 02, $year = 1976) {
        ...
        // Pre hook
        _hk('P' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $day, $month,$year);
        ...
        list ($_Date["month"], $_Date["day"], $_Date["year"], $_Date["ln"], $_Date["ml"]) = array($month, $day, $year, $iln, $ml);
         // result hook
        _hk('R' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $_Date);
    ...
    function Ism2Ge($IYear, $IMonth, $IDay) {


        // Pre hook
        _hk('P' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $IYear, $IMonth, $IDay);
...
//  $jd = (int)((11*$y+3)/30)+354*y+30*$m-(int)(($m-1)/2)+$d+1948440-385;
        ...
        $date_g[0] = $y;
         ...
         // result hook
        _hk('R' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $date_g);
    ...
    public function Parsi2Ge($jy, $jm, $jd) {
        ...
        // Pre hook
        _hk('P' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $jy, $jm,$jd);
     ...
     * @return string
     */
    function Ge2Parsi($gy, $gm, $gd) {

        // Pre hook
        _hk('P' . ':' . __CLASS__ . ':' . __FUNCTION__, $this, $gy, $gm,$gd);
        ...
        $result = array($jy, strlen($jm) == 1 ? "0$jm" : $jm, strlen($jd) == 1 ? "0$jd" : $jd);
